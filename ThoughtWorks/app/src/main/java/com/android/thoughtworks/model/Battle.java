...
public class Battle {
    ...
    public String toString() {
        return "ClassPojo [region = " + region + ", attacker_outcome = " + attacker_outcome + ", location = " + location + ", attacker_commander = " + attacker_commander + ", defender_size = " + defender_size + ", major_capture = " + major_capture + ", name = " + name + ", year = " + year + ", note = " + note + ", defender_king = " + defender_king + ", attacker_size = " + attacker_size + ", attacker_king = " + attacker_king + ", attacker_1 = " + attacker_1 + ", defender_1 = " + defender_1 + ", major_death = " + major_death + ", defender_3 = " + defender_3 + ", defender_2 = " + defender_2 + ", defender_4 = " + defender_4 + ", battle_type = " + battle_type + ", summer = " + summer + ", battle_number = " + battle_number + ", defender_commander = " + defender_commander + ", attacker_2 = " + attacker_2 + ", attacker_3 = " + attacker_3 + ", attacker_4 = " + attacker_4 + "]";
    }
}